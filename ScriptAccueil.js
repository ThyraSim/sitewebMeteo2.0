...
function unJour(liste)
{
    for (let index = 0; index < liste.length; index++) {
            ...
            if(dateJSON.getTime() === today.getTime())
            {
                dayOfWeek(dateJSON)
                ...
                tempMin.innerHTML = temp.TempMin+"&deg;C"
                tempMax.innerHTML = temp.TempMax
                chooseIcon(temp.TempDuJour)
                var iconePour1 = document.getElementById("icone")
                iconePour1.src = icone
                iconePour1.width = "100"
            }
        }
}
